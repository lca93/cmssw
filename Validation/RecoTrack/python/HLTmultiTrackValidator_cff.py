...
def _modifyForPhase2(trackvalidator):
    trackvalidator.label = ["hltGeneralTracks","hltHighPtTripletStepTrackSelectionHighPurity","hltHighPtTripletStepTracks","hltPhase2PixelTracks","hltInitialStepTrackSelectionHighPurity", "hltInitialStepTracks"]
